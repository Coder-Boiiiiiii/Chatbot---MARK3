...
int main()
{
    ...
    do {
        ...
        if (sentence == Question[0]) {
            ...
            cout << "ymusic for Youtube Music" << endl;
            cout << "dmusic for Deezer" << endl;
            cout << "scloud for Sound Cloud" << endl;
            cout << "spot for Spotify" << endl;
            cout << "gmusic for Google Play Music" << endl;
        }

        else if (sentence == "ymusic") {
            ...
            cout << "Redirecting to Webpage..." << endl;
            cout << "Redirect Successful!" << endl;
            system("start https://www.deezer.com/");
        }

        else if (sentence == "scloud") {
            cout << "Starting Browser..." << endl;
            cout << "Opening Browser..." << endl;
            cout << "Browser Opened!" << endl;
            cout << "Typing in URL..." << endl;
            ...
            cout << "Redirecting to Webpage..." << endl;
            cout << "Redirect Successful!" << endl;
            system("start https://soundcloud.com/");
        }

        else if (sentence == "spot") {
            cout << "Starting Browser..." << endl;
            cout << "Opening Browser..." << endl;
            cout << "Browser Opened!" << endl;
            cout << "Typing in URL..." << endl;
            ...
            cout << "Redirecting to Webpage..." << endl;
            cout << "Redirect Successful!" << endl;
            system("start https://www.spotify.com/us/");
        }

        else if (sentence == "gmusic") {
            cout << "Starting Browser..." << endl;
            cout << "Opening Browser..." << endl;
            cout << "Browser Opened!" << endl;
            cout << "Typing in URL..." << endl;
            ...
            cout << "Redirecting to Webpage..." << endl;
            cout << "Redirect Successful!" << endl;
            system("start https://play.google.com/music/");
        }
        ...
        else if (sentence == "holla") {
            cout << "Hi!" << endl;
        }

        else if (sentence == "sup") {
            cout << "Hey!" << endl;
        }

        else if (sentence == "salam") {
            cout << "Assalam o Alaikum" << endl;
        }

        else if (sentence == "Assalam o Alaikum") {
            cout << "Salam" << endl;
        }
            ...
            cout << "ghang for Google Hangouts" << endl;
        }
            ...
            cout << "Redirecting to Webpage..." << endl;
            cout << "Redirect Successful!" << endl;
            system("start https://hangouts.google.com/");
        }
            ...
            cout << sentence + " " + "is not valid, please enter a different command." << endl;
        }
    }
